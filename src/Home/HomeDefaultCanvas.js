...
export class HomeDefaultCanvas extends PureComponent {
    ...
    componentDidMount() {
        ...
        this.camera = new THREE.PerspectiveCamera(24, window.innerWidth / window.innerHeight, 8, 48);
    ...
    initForest() {
        ...
        const rockMaterial = initRockMaterial(textureLoader, 0xFFAFFF, {displacementScale: 1.1 });
