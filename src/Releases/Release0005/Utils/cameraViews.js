...
function getView4(camera) {
  camera.position.set(-2.5, -2.9, 3.7);
  camera.rotation.x = 1;
  camera.rotation.y = -.3;
  camera.rotation.z = -0.14;
  camera.fov = 60;
...
function getView9(camera) {
  camera.position.set(-2.5, .9, 3.7);
  camera.rotation.x = 0;
  camera.rotation.y = 2;
  camera.rotation.z = 0;
  camera.fov = 60;
...
function getView10(camera) {
  camera.position.set(2.5, .9, 1.7);
  camera.rotation.x = 0;
  camera.rotation.y = 2;
  camera.rotation.z = 0;
  camera.fov = 60;
