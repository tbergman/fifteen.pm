...
const BuildingsProvider = ({ ...props }) => {
    ...
    const attributes = useMemo(() => {
        return {
            ...
            "large_tall_logo_present_logo": { material: scuffedPlasticBlack },
            "large_tall_low_michigancentralstation": { material: scuffedPlasticBlack },
            ...
            "medium_short_diamond_future_diamondhull_geo001": { material: scuffedPlasticBlack },
            "medium_tall_diamond_future_diamondhull_geo": { material: metal03Black },
            "medium_tall_diamond_future_disco1": { material: tiles36 },
            "medium_tall_diamond_future_shinyhull1": { material: scuffedPlasticBlack },
            "medium_tall_diamond_future_unlithull_geo": { material: scuffedPlasticBlack },
            "medium_tall_diamond_future_unlithull_geo001": { material: scuffedPlasticBlack },
